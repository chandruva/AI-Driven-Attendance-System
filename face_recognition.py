...
class Face_Recognition:
    def __init__(self,root) :
        ...
        # 1st image
        img_top = Image.open(r"images\face_recognition3.png") 
        ...
        img_bottom = Image.open(r"images\face_recognition4.jpeg") 
        ...
        b1.place(x=150,y=500,width=200,height=40)
    
    def mark_attendence(self,n,r,d):
    ...
    def face_recog(self):
        def draw_boundary(img, classifier, scaleFactor, minNeighbours, color, text, clf):
            ...
            for (x, y, w, h) in features:
                ...
                # print(f"Student ID: {str(id)}, Name: {n}, Roll: {r}, Department: {d}")

                if confidence > 80:
                    cv2.putText(img, f"Roll:{r}", (x, y - 55), cv2.FONT_HERSHEY_COMPLEX, 0.8, (255, 255, 255), 3)
                    cv2.putText(img, f"Name:{n}", (x, y - 30), cv2.FONT_HERSHEY_COMPLEX, 0.8, (255, 255, 255), 3)
                    cv2.putText(img, f"Department:{d}", (x, y - 5), cv2.FONT_HERSHEY_COMPLEX, 0.8, (255, 255, 255), 3)
                    self.mark_attendence(n,r,d)

                else:
                    cv2.rectangle(img, (x, y), (x + w, y + h), (0, 0, 255), 3)
                    cv2.putText(img, "Unknown Face", (x, y), cv2.FONT_HERSHEY_COMPLEX, 0.8, (255, 255, 255), 3)
