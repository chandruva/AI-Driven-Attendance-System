...
class Student:
    def __init__(self,root) :
        ...
        # 1
        img = Image.open(r"C:\Users\ABDUL WAHAB\OneDrive\Desktop\AI_FACE_DETECTION\images\student-information.webp") 
        ...
        # 2
        img1 = Image.open(r"C:\Users\ABDUL WAHAB\OneDrive\Desktop\AI_FACE_DETECTION\images\student-information.webp") 
        ...
        # 3
        img2 = Image.open(r"C:\Users\ABDUL WAHAB\OneDrive\Desktop\AI_FACE_DETECTION\images\student-information.webp") 
        ...
        # bg image
        img3 = Image.open(r"C:\Users\ABDUL WAHAB\OneDrive\Desktop\AI_FACE_DETECTION\images\student-information.webp") 
        ...
        # Left label Frame
        Left_frame = LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Deatils",font=("times new roman",12,"bold"))
        Left_frame.place(x=10,y=10,width=760,height=580)

         # Left Image
        img_left = Image.open(r"C:\Users\ABDUL WAHAB\OneDrive\Desktop\AI_FACE_DETECTION\images\student-information.webp") 
        ...
        course_combo["values"] = ("Select Course", "BA", "BE", "BTECH", "MS")
        ...
        class_student_frame.place(x=10,y=285,width=740,height=270)
        ...
        save_btn = Button(class_student_frame,command=self.add_data,width = 10,text="Save",font=("times new roman",12,"bold"),bg="blue",fg="white")
        save_btn.grid(row=6,column=0)

        update_btn = Button(class_student_frame,command=self.update_data,width = 10,text="Update",font=("times new roman",12,"bold"),bg="blue",fg="white")
        update_btn.grid(row=6,column=1)

        delete_btn = Button(class_student_frame,command = self.delete_data,width = 10,text="Delete",font=("times new roman",12,"bold"),bg="blue",fg="white")
        delete_btn.grid(row=6,column=2)

        reset_btn = Button(class_student_frame,command=self.reset_data,width = 10,text="Reset",font=("times new roman",12,"bold"),bg="blue",fg="white")
        reset_btn.grid(row=6,column=3) 

        take_photo_btn = Button(class_student_frame,command=self.generate_dataset,width = 10,text="Take Photo",font=("times new roman",12,"bold"),bg="blue",fg="white")
        ...
        # Right label Frame
        Right_frame = LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Deatils",font=("times new roman",12,"bold"))
        Right_frame.place(x=780,y=10,width=700,height=580)

        # Right Image
        img_right = Image.open(r"C:\Users\ABDUL WAHAB\OneDrive\Desktop\AI_FACE_DETECTION\images\student-information.webp") 
        ...
        search_frame.place(x=5,y=140,width=680,height=70)
        ...
        search_btn = Button(search_frame,width = 10,text="Search",font=("times new roman",12,"bold"),bg="blue",fg="white")
        search_btn.grid(row=0,column=3)

        showAll_btn = Button(search_frame,width = 10,text="Show All",font=("times new roman",12,"bold"),bg="blue",fg="white")
        showAll_btn.grid(row=0,column=4)

        # Table frame
        table_frame = Frame(Right_frame,bd=2,bg="white",relief=RIDGE)
        table_frame.place(x=5,y=220,width=680,height=320)
    ...
    def add_data(self):
        if self.var_dep.get() == "Select Department" or self.var_std_name.get() == "" or self.var_std_id.get() == "":
            ...
            try:
                conn = mysql.connector.connect(host="localhost",username="root",password="Abdulwahab786",database="face_recognizer")
    ...
    def update_data(self):
        if self.var_dep.get() == "Select Department" or self.var_std_name.get() == "" or self.var_std_id.get() == "":
            ...
            try:
                ...
                if Update > 0:
                    conn = mysql.connector.connect(host="localhost", username="root", password="Abdulwahab786",
